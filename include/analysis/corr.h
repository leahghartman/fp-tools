 ...
 * computing time correlation functions such as VACF or custom
 * cross-correlations between time series extracted from simulation outputs.
 * FFT-based convolution is used for performance.
 *
 * Supported features:
 *  - VACF (Velocity Autocorrelation Function)
 *  - Custom two-signal correlations
...
//                std::vector<std::string>, std::vector<int>>>& custom, const
//                std::string& zero_pad = "next_pow2", bool subtract_mean =
//                true, bool normalize = true, const std::string& plot_format =
//                "png");
//
